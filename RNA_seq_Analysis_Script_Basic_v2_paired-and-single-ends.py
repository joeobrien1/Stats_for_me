...
''')      
        ...
        if options.paired=='0':
            ...
            if options.trim== '1':
                print >> script, 'mkdir '+Trimmed_Dir
                print >> script, 'java -jar '+Trimmer+' SE '+R1Path+' '+Trimmed_Dir+'/'+file[0:len(file)-12]+'_F_trimmed.fastq ILLUMINACLIP:/projects/genomicsshare/rna-seq_reference/McNally_Reference/adapters.fa:2:30:10 TRAILING:30 MINLEN:50'
                R1Path = Trimmed_Dir+'/'+file[0:len(file)-12]+'_F_trimmed.fastq'
